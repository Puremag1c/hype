...
### Шаг 2: Проверить и дополнить данные

> **Важно:** Базовая диагностика уже собрана в секции "Current System State" выше (gather_context). НЕ перезапускай те же команды — изучи что уже есть, и запусти только ДОПОЛНИТЕЛЬНЫЕ проверки по симптомам пользователя.
